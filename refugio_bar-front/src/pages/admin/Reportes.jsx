...
const Reportes = () => {
  ...
  return (
    <section id="reportes" className="content-section p-4">
      ...
      {/* ===== LOOKER / IFRAME (Integración de Looker Studio) ===== */}
      <div className="card shadow-sm">
        <div className="card-header fw-bold">Reporte de Looker Studio (Datos Vivos)</div>
        <div className="card-body">
          <p className="text-muted">
            Este marco muestra el dashboard de Looker Studio con los gráficos de categorías, top productos, etc., y se actualiza automáticamente.
          </p>

          <div className="ratio ratio-16x9">
            <iframe
              // URL de Looker Studio insertada aquí:
              src="https://lookerstudio.google.com/embed/reporting/9c9b4aaa-870a-42e7-b701-1cdb88538bc2/page/pAthF" 
              width="100%" // Ajustado para ser responsivo
              height="600" // Altura fija para el dashboard
              frameBorder="0"
              style={{ border: 0 }}
              allowFullScreen
